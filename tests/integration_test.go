...
const (
	...
	token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImFzcGFuIiwiZXhwIjoxNjY4MjE1NzQ3LCJpc3MiOiJlLXdhbGxldCJ9.oJoc8rnLQKvIQ_SzyrxP5QrMJqbXMPjbVcIWpBd0EhU"
)
